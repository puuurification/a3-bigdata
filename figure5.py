...
data_obes = merge.merge[(merge.merge['Country'].isin(countries)) & (merge.merge['year'] == max_year) & (merge.merge['Sex'] == 'Both sexes')].sort_values(by=['GDP_pp'], ascending=False)
